...
import io.qltb.qltb.service.PlanTargetResultService;
...
public class PlanTargetResultResource {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Long> updatePlanTargetResult(@PathVariable(name = "id") final Long id,
            @RequestBody @Valid final PlanTargetResultDTO planTargetResultDTO) {
    ...
    public ResponseEntity<Void> deletePlanTargetResult(@PathVariable(name = "id") final Long id) {
