...
import io.qltb.qltb.model.SupplyGroupDTO;
import io.qltb.qltb.service.SupplyGroupService;
...
public class SupplyGroupResource {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<SupplyGroupDTO> getSupplyGroup(@PathVariable(name = "id") final Long id) {
